...
**Note**: Use SLDS icon `/slds/icons/standard/account.svg` with colored background container.
...
**Note**: Use SLDS icon `/slds/icons/standard/contact.svg` with colored background (#A094ED).
